...
<?php
  ...
  $mysql = new DB();
  $dirs = $mysql->find("SELECT nom_theme FROM theme WHERE type_theme = 'serie' ORDER BY nom_theme;");
  foreach ($dirs as $k => $v) {
    ?>
