<form class="form-horizontal ajaxForm" data-value="Documentaire">
  <section class="left">
    <div class="control-group">
      <label class="control-label" for="docu">Nom</label>
      <div class="controls">
        <input class="required" name="nom_docu" data-type="varchar" type="text" id="docu" placeholder="Nom du documentaire" required>
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <select name="theme" id="theme">
          ...
          $mysql = new DB();
          $dirs = $mysql->find("SELECT * FROM theme WHERE type_theme = 'documentaire' ORDER BY nom_theme ;");
          foreach ($dirs as $k => $v) {
            ?>
    ...
    <div class="control-group">
      <label class="control-label" for="id_animateur">Animateur</label>
      <div class="controls">
