<form class="form-horizontal ajaxForm" data-value="Journal">
  <section class="left">
    <div class="control-group">
      <label class="control-label" for="journal">Nom</label>
      <div class="controls">
        <input class="required" name="nom_journal" data-type="varchar" type="text" id="journal" placeholder="Nom du journal" required>
