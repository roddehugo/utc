...
public:
    ...
    {
        return info;    //<! Retourne l'information stockée dans la classe
    }
private:
    std::string info;
};
...
public:
    ...
    {
        return annee;    //<! Retourne l'année de la date
    }
...
public:
    ...
    Date getDebut() const
    {
        return debut;    //<! Retourne la date de début de l'intervalle
    }
    Date getFin() const
    {
    ...
    int getDuree() const
    {
        return fin-debut;    //<! Retourne le nombre de jours s'écoulant entre le début et la fin de l'intervalle
    }
